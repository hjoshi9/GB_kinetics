...
#. Selecting a gb location (with a parameter ``gb_position`` used in :py:meth:`src.GBKineticsRunController.runGBkinetics`) and deleting atoms of grain 1 from one side of the gb position and from grain 2 on the other side.
...
.. figure:: /_static/sigma17_size1_disc0000.png
   ...
   :math:`\Sigma` 17 [001](410) symmetric tilt grain boundary as-cut configuration
...
energy is minimized (carried out by running :py:mod:`gridSearch`).
